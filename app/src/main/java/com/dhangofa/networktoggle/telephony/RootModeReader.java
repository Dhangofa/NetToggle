...
/**
 * Parses the current network mode by executing root shell commands.
 * It uses standard shell parsing to read the active mode out of the telephony service.
 */
...
final class RootModeReader {
    private final Context context;
    private final SimResolver simResolver;

    RootModeReader(Context context, SimResolver simResolver) {
